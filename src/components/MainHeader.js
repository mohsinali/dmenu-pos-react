      ...
      <div>
        <nav className="navbar navbar-static-top" role="navigation" style={{ marginBottom: 0 }}>
          ...
          <ul className="nav navbar-top-links navbar-right">
            <li>
              <span className="m-r-sm text-muted welcome-message">DMenu Point of Sale</span>
            </li>
            <li className="dropdown">
              ...
              <ul className="dropdown-menu dropdown-messages">
                <li>
                  <div className="dropdown-messages-box">
                    <a href="profile.html" className="pull-left">
                      <img alt="image" className="img-circle" src="/inspinia/img/a7.jpg" />
                    </a>
                ...
                <li>
                  <div className="dropdown-messages-box">
                    <a href="profile.html" className="pull-left">
                      <img alt="image" className="img-circle" src="/inspinia/img/a4.jpg" />
                    </a>
                    <div className="media-body ">
                ...
                <li>
                  <div className="dropdown-messages-box">
                    <a href="profile.html" className="pull-left">
                      <img alt="image" className="img-circle" src="/inspinia/img/profile.jpg" />
                    </a>
                    <div className="media-body ">
